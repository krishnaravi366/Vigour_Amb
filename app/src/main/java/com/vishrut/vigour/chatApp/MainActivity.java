package com.vishrut.vigour.chatApp;
...
import com.vishrut.vigour.chatApp.adapter.ChatFirebaseAdapter;
import com.vishrut.vigour.chatApp.adapter.ClickListenerChatFirebase;
import com.vishrut.vigour.chatApp.model.ChatModel;
import com.vishrut.vigour.chatApp.model.FileModel;
import com.vishrut.vigour.chatApp.model.MapModel;
import com.vishrut.vigour.chatApp.model.UserModel;
import com.vishrut.vigour.chatApp.util.Util;
import com.vishrut.vigour.chatApp.view.FullScreenImageActivity;
...
import static com.vishrut.vigour.FireBase.ReferenceUrl.CHILD_USERS;
import static com.vishrut.vigour.FireBase.ReferenceUrl.KEY_NAME;
...
//                photoCameraIntent();
    ...
    private void veryfiUserLogin(){
        ...
        if (mFirebaseUser == null){
            ...
            Uri photo_profile = mFirebaseUser.getPhotoUrl();
            String displayName = mFirebaseUser.getDisplayName();
            final String uid = mFirebaseUser.getUid();
            try {
                userModel = new UserModel(displayName, photo_profile.toString(), uid);
                lerMessagensFirebase();
            }catch (Exception e){
                DatabaseReference userRef = FirebaseDatabase.getInstance().getReference(CHILD_USERS).child(mFirebaseUser.getUid());
                userRef.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String displayName = dataSnapshot.child(KEY_NAME).getValue(String.class);
                        userModel = new UserModel(displayName,"https://cdn1.iconfinder.com/data/icons/ninja-things-1/1772/ninja-simple-512.png", uid);
                        lerMessagensFirebase();
                    }
