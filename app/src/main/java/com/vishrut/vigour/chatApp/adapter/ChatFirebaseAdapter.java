package com.vishrut.vigour.chatApp.adapter;
...
import static com.vishrut.vigour.chatApp.util.Util.local;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel, ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        String name = model.getUserModel().getName();
        if (model.getMapModel() != null) {
            ...
            if (model.getFile().getType().equals("img") && name.equals(nameUser)) {
                return RIGHT_MSG_IMG;
            } else {
                return LEFT_MSG_IMG;
            }
